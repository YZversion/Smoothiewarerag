# Dev setup from repo root (forwards to industrial-cpp-kb-lab).
# Usage: from Smoothiewarerag/:  .\scripts\setup_dev.ps1

$ErrorActionPreference = "Stop"

$LabRoot = Resolve-Path (Join-Path $PSScriptRoot "..\industrial-cpp-kb-lab")
$Target = Join-Path $LabRoot "scripts\setup_dev.ps1"
