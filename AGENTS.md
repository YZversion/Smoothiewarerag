...
| 10 | 🔄 | LLM 完整性：`validate_answer_coverage` + primary 清单注入；见 `phase10_conclusion.md` |
...
- **检索 gate**：Phase 6 冻结 gate = 全体 **mean cov@5 ≥ 70%**；Phase 8 当前 35 题 mean_cov@5=94%、mean sym_cov@trim=71%
