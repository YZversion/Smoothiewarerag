...
- **第一版不上** LangChain / LlamaIndex / Milvus / Qdrant / Agent / 知识图谱
...
| LLM | Claude API (`claude-sonnet-4-6`) | 代码理解能力强 |
...
# ctags 生成符号索引
ctags -R --c++-kinds=+p --fields=+iaS --extras=+q -f industrial-cpp-kb-lab/data/tags industrial-cpp-kb-lab/repos/Smoothieware/src
```
